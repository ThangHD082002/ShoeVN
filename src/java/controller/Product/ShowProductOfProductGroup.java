 ...
 */
@WebServlet(name = "ShowProduct", urlPatterns = {"/shoesgroup"})
public class ShowProductOfProductGroup extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (id != 0) {
                List<Product> list_Pid = msp.getProductsBy_PgId(id);
                request.setAttribute("products", list_Pid);
            } else {
